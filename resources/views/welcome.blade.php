        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        <label>ya tengo una seccion activa<a href="{{ url('/home') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">&nbsp;'clik aqui'</a></label>
                    @else
            ...
            <section>
                ...
                <img src="{{asset('images/galeria/2.jpg')}}">
                <img src="{{asset('images/galeria/3.jpg')}}">
                <img src="{{asset('images/galeria/4.jpg')}}">
                <img src="{{asset('images/galeria/5.jpg')}}">
            </section>
