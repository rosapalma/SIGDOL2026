<div>
        ...
        <div class="input-group mb-3">
           <input type="text" class="form-control" wire:model="correo"  placeholder="DIRECCION DE CORREO" aria-label="Recipient's username" aria-describedby="button-addon2" autofocus autocomplete>
