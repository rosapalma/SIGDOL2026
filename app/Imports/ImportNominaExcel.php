    ...
    public function collection(Collection $rows)
    {
        foreach ($rows as $row)
        {
            ...
            if ($emp){     
                ...
                'capaupel' => $row['capaupel'],
                'cappaoupel' => $row['cappaoupel'],
                'aproupel_seccional' => $row[ 'aproupel_seccional'],
                'aproupel_nacional' => $row[ 'aproupel_nacional'],
                'asoprojupel_docente' => $row['asoprojupel_docente'],
                'aseta_adm' => $row['aseta_adm'],
                'satiutecpri_obrero' => $row['satiutecpri_obrero'],
                'paro_forzoso' => $row['paro_forzoso'],
                'fondo_ipp'=> $row['fondo_ipp'],
                'islr' => $row['islr'],
                'total_deducciones' => $row['total_deducciones'],
                'salario_neto' => $row['salario_neto'],
                'aporte_seguro_social' => $row['aporte_seguro_social'],
                'aporte_ley_politica'=> $row['aporte_ley_de_politica'],
                'aporte_paro_forzoso'=>$row['aporte_paro_forzoso'],
                'aporte_capaupel' =>$row['aporte_capaupel'],
                'aporte_cappaoupel' =>$row['aporte_cappaoupel'],
                'aporte_fondo_ipp'=> $row['aporte_fondo_ipp'],
