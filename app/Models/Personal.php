...
{
    use HasFactory;
    protected $fillable = ['cedula','full_name','cargo','dep_adsc','categoria','email','fec_ing','fec_egre', 'dedication','porcentaje_jub_pens',
    'sexo','spacework_id','condicionlaboral_id','typepers_id', 'jerarquia','sede_id'];
